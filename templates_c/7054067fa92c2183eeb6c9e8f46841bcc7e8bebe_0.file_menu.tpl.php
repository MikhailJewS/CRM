...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.0',
  'unifunc' => 'content_674750b64e21a1_82268676',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7054067fa92c2183eeb6c9e8f46841bcc7e8bebe' => 
    array (
      0 => 'menu.tpl',
      1 => 1732509774,
      2 => 'file',
...
function content_674750b64e21a1_82268676 (\Smarty\Template $_smarty_tpl) {
		  ...
		  <li class="nav-item dropdown dropdown-user">
					<a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<div class="user-nav d-sm-flex d-none">
							<span class="user-name fw-bolder"><?php echo '<?'; ?>
=$arUser["LAST_NAME"];<?php echo '?>'; ?>
</span>
							<span class="user-status"><?php echo '<?'; ?>
=$arUser["NAME"];<?php echo '?>'; ?>
</span>
						</div>
						<span class="avatar"><img class="round" src="<?php echo '<?'; ?>
=$uph;<?php echo '?>'; ?>
" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
					</a>
					<div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
						<?php if ($_smarty_tpl->getValue('USER')->IsAdmin() || $_smarty_tpl->getSmarty()->getModifierCallback('in_array')(24,$_smarty_tpl->getValue('USER')->GetUserGroup($_smarty_tpl->getValue('USER')->GetID()))) {?>
						...
						<a class="dropdown-item" href="/partners/?a=y"><i class="me-50" data-feather="home"></i>Добавить контрагента</a>
								...
								<?php } elseif ($_smarty_tpl->getValue('USER')->isModerator()) {?>
								<?php echo '<?'; ?>
elseif(isModerator()):<?php echo '?>'; ?>
									...
									<a class="dropdown-item" href="/calculation/add/"><i class="me-50" data-feather="edit"></i>Добавить заказ</a>								
									<a class="dropdown-item" href="/otgruzki/?ao=y"><i class="me-50" data-feather="edit"></i>Добавить отгрузку</a>
								<?php } elseif (($_smarty_tpl->getValue('USER')->GetID() == 7)) {?>
								<?php echo '<?'; ?>
elseif($USER->GetID() == 7):<?php echo '?>'; ?>
								...
								<?php } elseif (($_smarty_tpl->getValue('USER')->GetID() == 43)) {?>
								<?php echo '<?'; ?>
elseif($USER->GetID() == 43):<?php echo '?>'; ?>

									<a class="dropdown-item" href="/suppliers/?add=y"><i class="me-50" data-feather="package"></i>Добавить поставщика</a>
									<a class="dropdown-item" href="/organizer/?add-task=y"><i class="me-50" data-feather="edit"></i>Добавить задачу</a>
								<?php echo '<?'; ?>
elseif (in_array(7,$USER->GetUserGroup($USER->GetID()))):<?php echo '?>'; ?>

									<a class="dropdown-item" href="/suppliers/?add=y">Добавить поставщика</a>	
								<?php } elseif (($_smarty_tpl->getValue('USER')->GetID() == 93)) {?>
								<?php echo '<?'; ?>
elseif($USER->GetID() == 93):<?php echo '?>'; ?>

									<a class="dropdown-item" href="/otgruzki/?ao=y"><i class="me-50" data-feather="edit"></i>Добавить отгрузку</a>							    
								<?php } elseif (($_smarty_tpl->getSmarty()->getModifierCallback('in_array')(array(9,13,14),$_smarty_tpl->getValue('USER')->GetUserGroup($_smarty_tpl->getValue('USER')->GetID())))) {?>
								<?php echo '<?'; ?>
elseif (in_array(array(9,13,14),$USER->GetUserGroup($USER->GetID()))):<?php echo '?>'; ?>

									<a class="dropdown-item" href="/calculation/add/"><i class="me-50" data-feather="edit"></i>Добавить заказ</a>
									<a class="dropdown-item" href="/otgruzki/?ao=y"><i class="me-50" data-feather="edit"></i>Добавить отгрузку</a>
									<a class="dropdown-item" href="/partners/?a=y"><i class="me-50" data-feather="home"></i>Добавить контрагента</a>
								<?php } elseif (($_smarty_tpl->getSmarty()->getModifierCallback('in_array')(8,$_smarty_tpl->getValue('USER')->GetUserGroup($_smarty_tpl->getValue('USER')->GetID())))) {?>
								<?php echo '<?'; ?>
elseif (in_array(8,$USER->GetUserGroup($USER->GetID()))):<?php echo '?>'; ?>

									<a class="dropdown-item" href="/calculation/add/"><i class="me-50" data-feather="edit"></i>Добавить заказ</a>
									<a class="dropdown-item" href="/otgruzki/?ao=y"><i class="me-50" data-feather="edit"></i>Добавить отгрузку</a>
									<a class="dropdown-item" href="/partners/?a=y"><i class="me-50" data-feather="home"></i>Добавить контрагента</a>
								<?php } elseif (($_smarty_tpl->getSmarty()->getModifierCallback('in_array')(15,$_smarty_tpl->getValue('USER')->GetUserGroup($_smarty_tpl->getValue('USER')->GetID())))) {?>
								<?php echo '<?'; ?>
elseif (in_array(15,$USER->GetUserGroup($USER->GetID()))):<?php echo '?>'; ?>

									<a class="dropdown-item" href="/payments/?action=add"><i class="me-50" data-feather="edit"></i>Добавить поступл-е (₽)</a>	
								<?php } elseif (($_smarty_tpl->getSmarty()->getModifierCallback('in_array')(19,$_smarty_tpl->getValue('USER')->GetUserGroup($_smarty_tpl->getValue('USER')->GetID())))) {?>
								<?php echo '<?'; ?>
elseif (in_array(19,$USER->GetUserGroup($USER->GetID()))):<?php echo '?>'; ?>
      ...
      <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl" role="navigation" data-menu="menu-wrapper" data-menu-type="floating-nav">
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
						...
						<li class="nav-item  <?php echo $_smarty_tpl->getValue('active');?>
" data-menu="">
